<h2><a href="https://practice.geeksforgeeks.org/problems/reverse-coding2452/1?page=1&difficulty[]=0&status[]=unsolved&sortBy=submissions">Reverse Coding</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You will be given an integer <strong>n</strong>, your task is to return the sum of all natural number less than or equal to <strong>n</strong>.</span></p>
